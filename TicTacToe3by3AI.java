    ...
    void checkWinner() {
        ...
        for (int row = 0; row < 3; row++) {
            if (board[row][0].getText().equals(currentPlayer) && 
                ...
                for (int i = 0; i < 3; i++) {
                    board[row][i].setBackground(new Color(153,255,204));
                }
                gameOver = true;
        ...
        for (int col = 0; col < 3; col++) {
            if (board[0][col].getText().equals(currentPlayer) && 
                ...
                for (int i = 0; i < 3; i++) {
                    board[i][col].setBackground(new Color(153,255,204));
                }
                gameOver = true;
                textLabel.setText(currentPlayer + " wins!");
                return;
        ...
        if (board[0][0].getText().equals(currentPlayer) && 
            ...
            for (int i = 0; i < 3; i++) {
                board[i][i].setBackground(new Color(153,255,204));
            }
            gameOver = true;
            textLabel.setText(currentPlayer + " wins!");
            return;
        ...
        if (board[0][2].getText().equals(currentPlayer) && 
            ...
            for (int i = 0; i < 3; i++) {
                board[i][2-i].setBackground(new Color(153,255,204));
            }
            gameOver = true;
            textLabel.setText(currentPlayer + " wins!");
            return;
